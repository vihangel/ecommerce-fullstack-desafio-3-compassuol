...
let ProductController = class ProductController {
    ...
    async findAll(categoryId, isNew, price, page = '1', limit = '10', sort, limitCompleted, discount) {
        const filters = {};
        if (categoryId) {
        ...
        return this.productService.findAll(filters, pageNumber, limitNumber, sort, limitCompleted, discount);
    }
    async findOne(id) {
...
__decorate([
    ...
    __param(7, (0, common_1.Query)('discount')),
